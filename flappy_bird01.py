...
class Passaro:
    ...
    def mover(self):
        # calcular e restringir o deslocamento
        self.tempo += 1
    ...
    def desenhar(self, tela):
        ...
        # enquanto cai, o pássaro não bate asas
        if self.angulo <= -80:
            self.imagem = self.imgs[1]
...
def main(genomas, config): #fitness funcition
    global geracao
    geracao += 1
    if ia_jogando:
        pass #criar vários pássaros
        redes =[]
        lista_genomas = []
        passaros = []
    ...
    while rodando:
        ...
        for i, passaro in enumerate(passaros):
            passaro.mover()
            #aumentar a fitness dos pássaros
